      ...
      <CardContent>
        <Tabs defaultValue="login" className="w-full" onValueChange={setActiveTab}>
          <TabsList className="grid grid-cols-2 w-full bg-slate-800">
            <TabsTrigger value="login" className="font-fixedsys data-[state=active]:bg-slate-700">Вход</TabsTrigger>
            <TabsTrigger value="register" className="font-fixedsys data-[state=active]:bg-slate-700">Регистрация</TabsTrigger>
          </TabsList>
